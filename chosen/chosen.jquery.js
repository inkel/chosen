...
(function() {
  ...
  Chosen = (function(_super) {
      ...
      if (!this.is_disabled) {
        ...
        if (!this.pending_destroy_click && !target_closelink) {
          if (!this.active_field) {
            ...
            if (this.options.dropdown_on_focus) this.results_show();
    ...
    Chosen.prototype.results_build = function() {
      var chosen, content, data, positions, startTime, _i, _j, _len, _len2, _ref;
      startTime = new Date();
      this.parsing = true;
    ...
    Chosen.prototype.choice_build = function(item) {
      ...
      this.choices += 1;
      this.search_container.before('<li class="search-choice ' + item.classes + '" id="' + choice_id + '"><span>' + item.html + '</span><a href="javascript:void(0)" class="search-choice-close" rel="' + item.array_index + '"></a></li>');
    ...
    Chosen.prototype.winnow_results = function() {
      var el, exact_match, found, option, part, parts, regex, result_id, results, searchText, startTime, startpos, text, zregex, _i, _j, _len, _len2, _ref;
      startTime = new Date();
          ...
          if (option.group) {
            ...
            if (found) {
              ...
              if (option.group_array_index != null) {
                document.getElementById(this.results_data[option.group_array_index].dom_id).style.display = "list-item";
              }
            } else {
      ...
      if ($.trim(this.search_field.val()) === "" && this.is_multiple) {
        return this.results_hide();
      }
    };
    ...
    Chosen.prototype.winnow_results_set_highlight = function() {
      ...
      if (!this.result_highlight) {
        ...
        do_high = selected_results.length ? selected_results.first() : this.search_results.find(".active-result.exact-match").first();
